...
#### 11.11.2022
Because this repo didnot update, You can use this [Repo](https://github.com/puskartrital/gdrive-cli-builder) to build and use gdrive.
...
```
### Other
Download `gdrive` from one of the [links in the latest release](https://github.com/puskartrital/gdrive/releases).
...
## Compile from source
```bash
go get github.com/puskartrital/gdrive
```
